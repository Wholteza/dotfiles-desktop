from src.distribution_installer.enums.distribution import Distribution
from src.distribution_installer.strategies.ubuntu_strategy import install as ubuntu_strategy
